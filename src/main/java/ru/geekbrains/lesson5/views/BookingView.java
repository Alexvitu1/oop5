...
public class BookingView implements View {
    ...
    public void showchangeReservationTable(int oldReservationNo, int reservationId){
    ...
    public void changeReservationTable(int oldReservationTable, Date reservationDate, int tableNo, String name){
        observer.cangeReservationTable(oldReservationTable, reservationDate, tableNo, name);
    }
